//! One-time Ed25519 keypair generator for chronikl license signing.
//!
//! Run with: `cargo run --example keygen`
//!
//! Outputs:
//! - The private key (hex) — store in your secrets vault, NEVER commit
//! - The public key as a Rust const — paste into `src/license/mod.rs`'s
//!   `PUBLIC_KEY_BYTES` constant
